...
export function GeofenceCard({
  ...
  return (
    <View className="bg-surface dark:bg-surface rounded-card p-4 gap-3 border border-slate-200">
      ...
      <View className="flex-row gap-2">
        <Pressable
          ...
          className="flex-1 min-h-[48px] flex-row items-center justify-center gap-2 rounded-input bg-slate-200"
        >
          <Pencil stroke={Colors.primary[600]} size={16} />
          <Text className="text-slate-800 font-medium">Edit</Text>
        </Pressable>
        <Pressable
          accessibilityRole="button"
