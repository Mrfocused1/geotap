  ...
  return (
    ...
    >
      <View className="pt-12 pb-2">
        ...
        <Text className="text-slate-50 text-3xl font-bold">Home</Text>
      </View>
      ...
      {nearestGeofence && distanceMeters !== null ? (
        <View className="bg-surface rounded-card p-4 border border-slate-700 gap-1">
          ...
          <Text className="text-slate-50 font-bold text-lg">
        ...
        <View className="bg-surface rounded-card p-4 border border-slate-700">
          <Text className="text-slate-400 text-sm">
      ...
      <View className="flex-row gap-3">
        <View className="flex-1 bg-surface rounded-card p-4 border border-slate-700 items-center gap-1">
      ...
      {lastUsed ? (
        <View className="bg-surface rounded-card p-4 border border-slate-700 gap-3">
          <View className="flex-row items-center gap-2">
          ...
          <Text className="text-slate-50 font-bold text-base">{lastUsed.name}</Text>
          <Pressable
            accessibilityRole="button"
      ...
      <View className="flex-row gap-3">
        <Pressable
          ...
          className="flex-1 bg-surface border border-slate-700 rounded-card py-3 flex-row items-center justify-center gap-2"
        >
          <Plus stroke={Colors.primary[600]} size={18} />
          <Text className="text-slate-200 font-semibold text-sm">Geofence</Text>
        </Pressable>
        <Pressable
          accessibilityRole="button"
        ...
        >
          <Plus stroke={Colors.primary[600]} size={18} />
          <Text className="text-slate-200 font-semibold text-sm">Checklist</Text>
        </Pressable>
      </View>
    </ScrollView>
  );
